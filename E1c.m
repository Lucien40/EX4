...
pDt = plot(axDt,t/timeScale,dt/timeScale,...
    '+'                                ,...
    'Color',            M('light red') ,...
    'MarkerEdgeColor',  M('dark red') ,...
    'MarkerSize',       2               ,...
    'LineWidth',        1   );

axDt.XLabel.String = 't [day]';
axDt.YLabel.String = 'size of dt [day]';


pD = plot(axDis,t/timeScale,h,...
    '+'                                ,...
    'Color',            M('light red') ,...
    'MarkerEdgeColor',  M('dark red') ,...
    'MarkerSize',       2               ,...
...
axDis.XLabel.String = 't [day]';
axDis.YLabel.String = 'h [m]';
